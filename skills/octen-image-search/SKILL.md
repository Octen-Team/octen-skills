...
Find images on the web by a **text query and/or a reference image**. Each result
includes a thumbnail, the source page, dimensions, and a description.
...
Text and image can be combined in one `inputs` array. For a local image, send
`{"type": "image", "data": "<base64>"}` (≤5MB; JPEG/PNG/etc.).

## Parameters

| Parameter | Type | Required | Default | Description |
|--|--|--|--|--|
| `inputs` | array | **Yes** | - | Text and/or image inputs: `{"type":"text","data":"<query≤500>"}` and/or `{"type":"image","url":"<url>"}` or `{"type":"image","data":"<base64>"}` |
